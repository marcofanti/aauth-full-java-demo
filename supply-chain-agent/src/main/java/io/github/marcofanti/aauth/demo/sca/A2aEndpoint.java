...
public class A2aEndpoint {
    ...
    private final SupplyChainOptimizer optimizer;
    ...
    private String dispatch(String body) {
        ...
        String report = optimizer.optimize(text);
    ...
    private static AgentCard buildCard(String agentUrl) {
        return new AgentCard(
                ...
                "Supply Chain Agent",
                "Optimizes laptop procurement against business policies; can delegate market analysis",
                agentUrl,
                "0.1.0",
                ...
                List.of(
                        new AgentSkill(
                                ...
                                "Supply Chain Optimization",
                                "Applies procurement policies and produces an optimization report",
                                List.of("supply-chain", "optimization", "procurement")),
                        new AgentSkill(
                                "market-analysis-delegation",
                                "Market Analysis Delegation",
                                "Delegates to the market-analysis agent when the request asks for it",
                                List.of("delegation", "market-analysis"))));
    }
}
